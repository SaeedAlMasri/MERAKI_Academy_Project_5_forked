...
const { createItem, getAllItem, getItemById, updateItemById, deleteItemByIdSoft, getItemByCatId, getItemByUserId } = require("../controllers/itemController");
...
itemRoute.get("/getItemByUser/:userId", authentication, getItemByUserId);
